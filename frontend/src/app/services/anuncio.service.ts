...
export class AnuncioService {
  ...
  public updateAnuncio(anuncio: Anuncio): Observable<any> {
    ...
    return this._http.put(
      this.urlBase + 'anuncio/' + anuncio._id,
      body,
      httpOptions
    );
  }
  ...
  public deleteAnuncio(id: string): Observable<any> {
    ...
    return this._http.delete(
      this.urlBase + 'anuncio/eliminar/' + id,
      httpOptions
    );
  }
  ...
  public getAnuncioPorArea(idArea: string): Observable<any> {
    const httpOptions = {
      headers: new HttpHeaders({}),
      params: new HttpParams().append('area', idArea),
    };
  ...
  public getAnuncioPorRedactor(idRedactor: string): Observable<any> {
    const httpOptions = {
      headers: new HttpHeaders({}),
      params: new HttpParams().append('redactor', idRedactor),
    };
    return this._http.get(
      this.urlBase + 'anuncio/filtro/redactor',
      httpOptions
    );
  }
  ...
  public getAnuncioPorAutorizar(idArea: string): Observable<any> {
    ...
    return this._http.get(
      this.urlBase + 'anuncio/filtro/areaYestado',
      httpOptions
    );
  }
  ...
  public getAnunciosPorRol(idRol: string): Observable<any> {
    const httpOptions = {
      headers: new HttpHeaders({}),
      params: new HttpParams().append('rol', idRol),
    };
  ...
  public getAnunciosBusqueda(
    ...
    const httpOptions = {
      headers: new HttpHeaders({}),
      params: new HttpParams()
        .append('textoAnuncio', textoAnuncio)
        .append('estado', estado)
    };
    return this._http.get(
      this.urlBase + 'anuncio/busquedaAvanzada',
      httpOptions
    );
  }

  public getAnunciosPorFecha(
    fechaI: string,
    fechaF: string
  ): Observable<any> {
    const httpOptions = {
    ...
    return this._http.get(
      this.urlBase + 'anuncio/busquedaRangoFecha',
      httpOptions
    );
  }
}
